...
housePrices2022 = read_csv(
  ".\\CourseWork_Ds_sabjaShrestha\\Obtained Data\\housePrices2022.csv",
  col_names = houseColsNames
)
housePrices2023 = read_csv(
  ".\\CourseWork_Ds_sabjaShrestha\\Obtained Data\\housePrices2023.csv",
  col_names = houseColsNames
)
housePrices2024 = read_csv(
  ".\\CourseWork_Ds_sabjaShrestha\\Obtained Data\\housePrices2024.csv",
  col_names = houseColsNames
)
...
write_csv(
  housePrices2022,
  ".\\CourseWork_Ds_sabjaShrestha\\CleanedData\\CleanedHousePrices2022.csv",
)

write_csv(
  housePrices2023,
  ".\\CourseWork_Ds_sabjaShrestha\\CleanedData\\CleanedHousePrices2023.csv",
)

write_csv(
  housePrices2024,
  ".\\CourseWork_Ds_sabjaShrestha\\CleanedData\\CleanedHousePrices2024.csv",
)
